...
"""#  Set up classes to handle geometry

* define mesh and time steps
* define fluid properties
* set boundary conditions
* solve momentum equation for pressure and velocity
* see formal notation here http://www.thevisualroom.com/poisson_for_pressure.html

* unhide code below by selecting next cell and using "View>>hide cell" menu above
"""
